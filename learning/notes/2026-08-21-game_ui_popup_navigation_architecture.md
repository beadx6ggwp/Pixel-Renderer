...
狀態: `learning/` 裡的 long-form learning note. 這不是 current source truth, 也不是已採納的 architecture decision.
...
- [`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md): current short/mid/long architecture 與 Debug UI 位置.
- [`docs/PROJECT_MAP.md`](../../docs/PROJECT_MAP.md): Rendering Systems Lab 的 UI / Tooling branch.
...
- [`I-14 Immediate-mode UI Integration Boundary`](../cpp/impl/i14_immediate_mode_ui_integration_boundary.html): `UiContext`, widget state, draw list, font atlas, clip, alpha blend.
